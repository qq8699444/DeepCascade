                            ...
                            const bool use_ground_plane)
{
    ...
    //printf("ObjectsDetectorFactory::new_instance(options)SYLARRRRRRRRRRRRR\n");
    objects_detector_p.reset(ObjectsDetectorFactory::new_instance(options));
    ...
    if(use_ground_plane)
    {
        printf("use_ground_plane OOOOOOOOOOOOOOOOOOOO\n");
...
void set_monocular_image(input_image_const_view_t &input_view, cv::Mat input_mat)
{
    //printf("set_monocular_image SYLARRRRRRRRRRRRRRR\n");
    ...
    if(add_border_p)// SYLAR add_border_p == false
    {
    ...
    else
    {
        ...
        objects_detector_p->set_mat(input_mat);// Sylar added
    }
